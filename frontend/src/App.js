          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div className="space-y-8">
              ...
              <div className="bg-gradient-to-br from-gold/15 to-gold/5 rounded-xl p-6 border border-gold/20 shadow-lg">
                <h4 className="text-xl font-serif font-light mb-3 text-white">Quick Response</h4>
                <p className="text-white/85 mb-4 font-light text-sm leading-relaxed">Get instant answers via WhatsApp for immediate assistance and quick quotes.</p>
                <a 
                  href="https://wa.me/420775505805"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center bg-gold text-primary px-6 py-2.5 rounded-xl font-medium hover:bg-gold/90 transition-all duration-300 hover:scale-105 shadow-md"
                >
